...
def get_models(img_height, img_width, download_weights=True):
    ...
    if download_weights:
        text_encoder_weights_fpath = keras.utils.get_file(fname = 'text_encoder.h5',
        ...
        diffusion_model_weights_fpath = keras.utils.get_file(fname = 'diffusion_model.h5',
        ...
        decoder_weights_fpath = keras.utils.get_file(fname = 'decoder.h5',
            origin="https://huggingface.co/fchollet/stable-diffusion/resolve/main/decoder.h5",
            file_hash="6d3c5ba91d5cc2b134da881aaa157b2d2adc648e5625560e3ed199561d0e39d5",
        )

        encoder_weights_fpath = keras.utils.get_file(fname = 'encoder_newW.h5',
